        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active hoverable">
                    <a class="nav-link" href="https://lavankumar.000webhostapp.com/tansim_auth/dashboard.php"><button class="btn btn-outline-secondary"> Dashboard </button></a>
                </li>
                <li class="nav-item hoverable">
                    <a class="nav-link" href="https://lavankumar.000webhostapp.com/tansim_auth/events.php"><button class="btn btn-outline-secondary"> Events </button></a>
                </li>

                <li class="nav-item hoverable">
                    <a class="nav-link" href="https://lavankumar.000webhostapp.com/tansim_auth/addevent.php"><button class="btn btn-outline-secondary"> Add Event </button></a>
                </li>
